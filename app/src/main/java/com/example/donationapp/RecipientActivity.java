...
public class RecipientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayFragment(new ReceipientDonations());

        // Handle navigation between fragments
        BottomNavigationView bottomNavigationView = findViewById(R.id.bottomNavigationViewReceipt);
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.menu_my_donations:
                    displayFragment(new ReceipientRequests());
                    return true;
                default:
                    return false;
            }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            startActivity(new Intent(RecipientActivity.this, MainActivity.class));
